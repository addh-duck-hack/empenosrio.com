...
$carouselPrincipal = array(
  'category__and' => array($apan_id, $interno_id),
  'posts_per_page' => 4
);
    ...
    <header class="site-header">
        <div class="container">
            ...
            <div class="row justify-content-end social-icons">
                <div class="col-auto">
                    <a href="https://www.facebook.com/profile.php?id=100055258322516" target="_blank">
                      <img class="social-icons-item" src="<?php echo get_template_directory_uri(); ?>/assets/img/facebook.png" alt="">
                    </a>
                    <a href="https://wa.me/5217751917717" target="_blank">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    <p class="label-footer">Empeños Rio Apan</p>
                    <p class="label-footer">Calle reforma #20, Col. Centro, Apan, Hidalgo</p>
                    <p class="label-footer"><a href="tel:+527486881377">Telefono: 748-688-1377</a></p>
                </div>
                <div class="col-12 col-md-6">
