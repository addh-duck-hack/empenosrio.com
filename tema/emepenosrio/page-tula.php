...
$carouselPrincipal = array(
  'category__and' => array($tula_id, $interno_id),
  'posts_per_page' => 4
);
    ...
    <header class="site-header">
        <div class="container">
            ...
            <div class="row justify-content-end social-icons">
                <div class="col-auto">
                  <a href="https://www.facebook.com/profile.php?id=100009524534853" target="_blank">
                    <img class="social-icons-item" src="<?php echo get_template_directory_uri(); ?>/assets/img/facebook.png" alt="">
                  </a>
                  <a href="https://wa.me/5217731990816" target="_blank">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    <p class="label-footer">Empeños Rio Tula</p>
                    <p class="label-footer">Calle 5 de Mayo #305, Col. Centro, Tula de Allende</p>
                    <p class="label-footer"><a href="tel:+527737322714">Telefono: 773-732-2714</a></p>
                </div>
                <div class="col-12 col-md-6">
