<?php
/*
Template Name: Sucursal Pachuca
*/
?>
...
$carouselPrincipal = array(
  'category__and' => array($pachuca_id, $interno_id),
  'posts_per_page' => 4
);
    ...
    <header class="site-header">
        <div class="container">
            ...
            <div class="row justify-content-end social-icons">
                <div class="col-auto">
                  <a href="https://www.facebook.com/prestamos.riopachuca.9" target="_blank">
                    <img class="social-icons-item" src="<?php echo get_template_directory_uri(); ?>/assets/img/facebook.png" alt="">
                  </a>
                  <a href="https://wa.me/5217714866306" target="_blank">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    <p class="label-footer">Empeños Rio Pachuca</p>
                    <p class="label-footer">Calle Ignacio Allende #406, Col. Centro, Pachuca, Hidalgo</p>
                    <p class="label-footer"><a href="tel:+527717150971">Telefono: 771-715-0971</a></p>
                </div>
                <div class="col-12 col-md-6">
